...
describe('AddSpecialtyForm Test', () => {
  ...
  test('Show an error message in posting data when name and code exists in DB', async ()=> {
    ...
    const postPromiseBadRequest = {"errors":{"Code":["Such Code is exists in the database"],"Name":["Such Name is exists in the database"]},"type":"https://tools.ietf.org/html/rfc7231#section-6.5.1","title":"One or more validation errors occurred.","status":400,"traceId":"|961fb394-4faa4b922ca00653."}
