...
import InstitutionOfEducationAdminPage from '../../pages/institutionOfEducationRolePages/institutionOfEducationAdminPage';
import NewPasswordPage from '../../pages/newPasswordPage';
import ScrollToTop from '../common/scrollToTop/scrollToTop';
import SuperAdmin from '../../pages/superAdminPages/index';
import GraduateAccountPage from '../../pages/graduatePage';
import InstitutionOfEducationModeratorPage from '../../pages/institutionOfEducationRolePages/institutionOfEducationModeratorPage';
