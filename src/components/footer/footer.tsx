    ...
    <footer>
      <div className={styles.footer} style={{ background: props.background }}>
        <section className={styles.mainElements}>
          <article>
            {/* <Link to='/login'>
              <button className={styles.animatedButtonTransparent}>Вхід</button>
            </Link>
            <Link to='/register'>
            ...
            <p>
              <Link to='mailto:#'>exampleYourITFuture@example.com</Link>
            </p>
          </article>
          <article>
          ...
          <article>
            <p>
              <Link className={styles.linkstyle} to='/directions'>
                Напрями
              </Link>
            </p>
            <p>
              <Link className={styles.linkstyle} to='/universities'>
                Університети
              </Link>
            </p>
          </article>
