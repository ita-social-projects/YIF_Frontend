...
import Administrator from '../../institutionOfEducationModeratorPage/administrator';
...
const InstitutionOfEducationInfo = (props: props) => {
    ...
    content = (
      <main className={styles.wrapper}>
        <div className={styles.infoContainer}>
          ...
          />
          {(props.role === 'moderator') ? <Administrator/> : null}
          {(props.role === 'administrator') ? <Link
            className={`${styles.animatedButton} ${styles.buttonLink}`}
            to={`${path}/edit`}
          >Редагувати</Link> : null}
        </div>
      </main>
    );
  }
